...
const Reviews = () => {
	...
	const reviews = [{
		img: "./r1.png",
		name: "Лиза",
		text: "С дорогой моей Анной мы знакомы уже тысячу лет. Это мой духовный наставник, моя помощница, целительница и просто очень важный человек в моей жизни! Столько раз выручала меня, спасала от бед, уберегала от неверных шагов. Долгих лет здоровья вам, и спасибо за то, что делаете!"
	}, {
		img: "./r2.png",
		name: "Владислав",
		text: "Анна, Вы оказывается были правы. Прошло 4 месяца и все сбылось как Вы и предсказывали. Вы так мягко давали свои советы относительно моей ситуации, что я не счел нужным им последовать. Быть хозяином своей жизни не так легко как кажется многим. Но я удивлен. И буду к Вам обращаться. Спасибо, и еще раз спасибо!!"
	}, {
		img: "./r3.png",
		name: "Айгерим",
		...
		img: "./r4.png",
		name: "Дарья",
		text: "Хочу выразить благодарность Ане, направила меня в нужное направление в моей семейной жизни. Словами не описать весь восторг, спасибо огромное за понимание и за оказанную помощь."
	}]
